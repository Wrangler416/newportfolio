        ...
        <Card style={{backgroundColor: '#001540'}}>
          <CardContent>
            ...
            <Typography
                ...
                variant="h4">I design and develop applications that inspire and captivate 
            </Typography>
            ...
            <Button 
                ...
                color="secondary"
                variant="outlined"
                href="https://www.canva.com/design/DAE3u2HTVNM/tR5RmakZ3Ctpw5cmMOZ5hQ/view?utm_content=DAE3u2HTVNM&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink">resume
            </Button>
            <Button 
                size="large"
                color="secondary"
                variant="outlined"
                href="https://github.com/Wrangler416?tab=repositories">GitHub
            </Button>
            </CardActions>
            <Typography 
                color="secondary"
                variant="h2"
                style={{textAlign: "center", margin: "2rem", fontFamily: 'Quicksand'}}>Projects 
            </Typography>    
        </Card>        
      </Grid>
    </Grid>
        ...
        <Link href={"https://e-shop-rho.vercel.app/"}>
          <Card style={{backgroundColor: '#001540', margin: ".2rem"}}>
            ...
            <Typography 
                ...
                variant="h3"
                margin="1rem">Shopify & React 
            </Typography>
            <Typography 
                variant="h4"
                color="secondary"
                style={{fontFamily: 'Urbanist', textAlign: "center", margin: '.5rem'}}>E Commerce Nike Clone 
            </Typography>
            </CardContent>
            </CardActionArea>
            ...
            <Button 
                ...
                color="secondary"
                variant="outlined"
                href="https://github.com/Wrangler416/e-shop">Site
            </Button>
            <Button 
                size="large"
                color="secondary"
                variant="outlined"
                href="https://github.com/Wrangler416/e-shop">Repo
            </Button>
            </CardActions>
          </Card>
        </Link>
        ...
        <Link href={"https://disney-plus-eta.vercel.app/"}>
          <Card style={{backgroundColor: '#001540', margin: ".2rem"}}>
            ...
            <Typography 
                ...
                color="secondary"
                style={{textAlign: "center",fontFamily: 'Urbanist'}}
                variant="h3">NextJS & GraphCMS
            </Typography>
            <Typography 
                variant="h4"
                color="secondary"
                style={{fontFamily: 'Urbanist', textAlign: "center", margin: '.5rem'}}>A Disney Plus clone
            </Typography>
           </CardContent>
           </CardActionArea>
           <CardActions style={{ display: "flex", justifyContent: "center", alignItems: "center"}}>
           <Button 
                ...
                color="secondary"
                variant="outlined"
                href="https://disney-plus-eta.vercel.app/">Site
            </Button>
            <Button 
                size="large"
                color="secondary"
        ...
        <Link href={"https://space-x-dusky.vercel.app/"}>
          <Card style={{backgroundColor: '#001540', margin: ".2rem"}}>
            ...
            <Typography 
                variant="h4"
                color="secondary"
                style={{fontFamily: 'Urbanist', textAlign: "center", margin: '.5rem'}}>Space X Launches
            </Typography>
            </CardContent>
            </CardActionArea>
            <CardActions style={{ display: "flex", justifyContent: "center", alignItems: "center"}}>
            <Button 
                ...
                color="secondary"
                variant="outlined"
                href="https://space-x-dusky.vercel.app/">Site
            </Button>
            <Button 
                size="large"
                color="secondary"
                variant="outlined"
                href="https://github.com/Wrangler416/spaceX">Repo
            </Button>
            </CardActions>
          </Card>
        </Link>
          ...
          <Link href={"http://www.kitesurfcat.com/"}>
            <Card style={{backgroundColor: '#001540', margin: ".2rem"}}>
              ...
              <Typography 
                ...
                margin="1rem"
                style={{textAlign: "center",fontFamily: 'Urbanist'}}
                variant="h3">HTML5 / CSS3
              </Typography>
              <Typography 
                variant="h4"
                color="secondary"
                style={{fontFamily: 'Urbanist', textAlign: "center", margin: '.5rem'}}>Kitesurfing Company 
              </Typography>
              </CardContent>
              </CardActionArea>
              <CardActions style={{ display: "flex", justifyContent: "center", alignItems: "center"}}>
              <Button 
                ...
                color="secondary"
                variant="outlined"
                href="http://www.kitesurfcat.com/">Site
              </Button>
              </CardActions>
            </Card>
          </Link>
          ...
          <Card style={{backgroundColor: '#001540'}}>
           <CardContent style={{textAlign: "center"}}>
              <Typography
                ...
                color="secondary"
                variant="h4"
                style={{fontFamily: 'Urbanist'}}>Created with NextJS & Material UI 
              </Typography>
              <CardActions style={{ display: "flex", justifyContent: "center", alignItems: "center"}}>
              <Button 
                size="large"
